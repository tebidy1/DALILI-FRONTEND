...
/** رسالة الفشل الصادقة (معيار القبول ④) — الخطوة تبقى قابلة للطمس في المحرر */
export const BLUR_FAIL_NOTICE = 'تعذّر الطمس المباشر (E-CAP-13) — يمكنك طمس المنطقة لاحقًا في المحرر'
