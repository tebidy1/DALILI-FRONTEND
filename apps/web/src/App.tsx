...
export function App() {
  ...
  // I18N-01: اشتراك اللغة — تبدّلها يعيد تركيب الشجرة (key) فتلتقط كل t() اللغة الجديدة.
  // التعادل مع تحديث الصفحة: الحفظ الآلي يغطي المحرر، والتبديل يجري من الإعدادات/الدخول.
